...
using Manifolds, ForwardBackward, Distributions

import ForwardBackward: ManifoldProcess, ManifoldState, interpolate, perturb, endpoint_conditioned_sample, flatview, expand
...
"""
ManifoldState(M::AbstractManifold, state::AbstractArray{<:AbstractArray}) = ManifoldState(ForwardBackward.ArrayOfSimilarArrays(state), M)
